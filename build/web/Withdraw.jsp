<%-- 
    Document   : Withdraw
    Created on : 18 Jul, 2012, 2:43:39 PM
    Author     : aadi
--%>
...
<html:html>
    ...
    <body>
        <% 
                        ...
                        %>
        <form action="with.do" method="post">
        ...
        <td width="564" align="left" valign="top"><h2 align="center">&nbsp;</h2>
                                <h2 align="center"><font color="#CC0033" >Withdraw Money</font></h2>
                                <p align="center">&nbsp;</p>   
        </table> 
                        
                        <form action="dep.do" method="post">
                        <table width="557" height="255" border="0" cellpadding="0" cellspacing="0">
                                           <tr>
                                            <td width="254" height="61" align="left" valign="top"><p>&nbsp;</p>
                                            <p align="right"><span class="style2">&nbsp;&nbsp;Enter amount You want to Withdraw                  </span></p></td>
                                        ...
                                        <tr>
                                            ...
                                            <input type="Submit" value="Withdraw" width="105" height="21" />
